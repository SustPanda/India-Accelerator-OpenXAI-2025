...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-red-600 to-white-600 p-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center text-white mb-12">
            <h1 className="text-6xl font-bold mb-4 bounce">👁️ Vision Template</h1>
            <p className="text-xl opacity-90 bounce" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 bounce" style={{ animationDelay: '0.6s' }}>
            ...
            {/* Analysis Results */}
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 bounce" style={{ animationDelay: '0.9s' }}>
          ...
          <div className="mt-12 text-center">
            <div className="bg-black/20 rounded-lg p-8 backdrop-blur-sm bounce" style={{ animationDelay: '1.2s' }}>
